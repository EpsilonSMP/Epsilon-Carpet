package xyz.epsilonsmp.EpsilonCarpet.commands;

import com.mojang.brigadier.CommandDispatcher;
import com.mojang.brigadier.builder.LiteralArgumentBuilder;
import xyz.epsilonsmp.EpsilonCarpet.EpsilonCarpetSettings;
import xyz.epsilonsmp.EpsilonCarpet.utils.PlayerHelper;
...
public class CommandLocation {
    ...
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        LiteralArgumentBuilder literalargumentbuilder = literal("location")
                .requires((player) -> EpsilonCarpetSettings.commandLocation)
    ...
    private static int locate(ServerCommandSource source, ServerPlayerEntity player) {
        if (!EpsilonCarpetSettings.commandLocation || player == null)
            return 0;
