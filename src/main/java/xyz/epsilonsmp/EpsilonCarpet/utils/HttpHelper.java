...
import xyz.epsilonsmp.EpsilonCarpet.EpsilonCarpetExtension;
...
public class HttpHelper {
    ...
    private static final String LATEST_RELEASE = "GET https://api.github.com/repos/EpsilonSMP/Epsilon-Carpet/releases/latest";
    ...
    public static String getLatestRelease() {
        ...
        try {
            ...
            response = EpsilonCarpetExtension.VERSION;
        }
        return response;
    }
